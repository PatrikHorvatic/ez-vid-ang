 ...
 */
export type EvaTrackKind = "subtitles" | "captions" | "descriptions" | "chapters" | "metadata";
 ...
 */
export type EvaTrack = EvaSubtitleTrack | EvaCaptionTrack | EvaDescriptionTrack | EvaChapterTrack | EvaMetadataTrack;
