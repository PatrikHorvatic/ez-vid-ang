...
export class EvaMediaEventListenersDirective implements OnInit, OnDestroy {
  ...
  private enteredPiP$: Observable<PictureInPictureEvent> | null = null;
  private leftPiP$: Observable<PictureInPictureEvent> | null = null;
  ...
  private enteredPipSub: Subscription | null = null;
  private leftPipSub: Subscription | null = null;
